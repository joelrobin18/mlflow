...
def autolog(*, log_traces: bool = True, disable: bool = False, silent: bool = False) -> None:
    ...
    class_map.update(
        {
            "agno.storage.sqlite.SqliteStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.dynamodb.DynamoDbStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.json.JsonStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.mongodb.MongoDbStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.mysql.MySQLStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.postgres.PostgresStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.yaml.YamlStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.singlestore.SingleStoreStorage": ["create", "read", "upsert", "drop", "upgrade_schema"],
            "agno.storage.redis.RedisStorage": ["create", "read", "upsert", "drop", "upgrade_schema"]
        }
    )
